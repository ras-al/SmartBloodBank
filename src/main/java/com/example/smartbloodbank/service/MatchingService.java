...
public class MatchingService {
    ...
    /**
     * Finds the best available blood source for a given request.
     * @param request The blood request to be fulfilled.
     * @return A User object representing the matched donor, or null if no match is found.
     */
